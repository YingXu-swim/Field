...
protected:
    ...
    dvec2 cellPosition(double i, double j, const VectorField2 vectorField);
    ...
    vec4 classifyCriticalPoints(const vec2 pos, const VectorField2 vectorField, std::vector<std::vector<dvec2>>& separatrices);
    std::vector<std::vector<glm::dvec2>> computeSeparatrices(glm::dvec2 saddle, const VectorField2& vectorField, glm::mat2 eigenvectors);
